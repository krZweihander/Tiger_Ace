...
function cgui:guisetposition()
	...
	self.title:setPosition(device_width/2, margin*4)
	self.credit:setPosition(device_width/2, self.title:getY() + (self.title:getHeight()/2) + (margin*2))
	self.start_button:setPosition(device_width/2, device_height - self.mkill:getHeight() - (margin*4))
	
	self.gameover:setPosition(device_width/2, margin*3)
	self.mkill:setPosition(device_width/2, self.gameover:getY() + (self.gameover:getHeight()/2) + (margin*4))
	self.mwave:setPosition(device_width/2, self.mkill:getY() + (self.mkill:getHeight()/2) + (margin*2))
	self.restart_button:setPosition(device_width/2, device_height - self.mkill:getHeight() - (margin*4))
